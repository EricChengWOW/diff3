...
def main():
    ...
    if args.dataset == "KITTI":
        dataset = KITTIOdometryDataset(args.data_folder, seq_len=args.n, stride=args.data_stride)
        ...
        dataset = RobotcarDataset(args.data_folder, seq_len=args.n, stride=args.data_stride)
        dataloader = torch.utils.data.DataLoader(dataset, batch_size=args.batch_size, shuffle=args.shuffle)
